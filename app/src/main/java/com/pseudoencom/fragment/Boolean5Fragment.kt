...
class Boolean5Fragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_boolean5, container, false)


        editText = view.findViewById(R.id.editTextBoolean5)
        editText2 = view.findViewById(R.id.editTextBoolean5_1)
        button = view.findViewById(R.id.buttonBoolean5)
        view.findViewById<Button>(R.id.buttonBoolean5).setOnClickListener(this)
        return view
    }
