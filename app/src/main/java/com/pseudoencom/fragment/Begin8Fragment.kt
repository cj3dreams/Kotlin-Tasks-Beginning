...
class Begin8Fragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_begin8, container, false)


        editText = view.findViewById(R.id.editTextBegin8)
        editText2 = view.findViewById(R.id.editTextBegin8_1)
        button = view.findViewById(R.id.buttonBegin8)
        view.findViewById<Button>(R.id.buttonBegin8).setOnClickListener(this)
        return view
    }
        ...
        when {
            editText.text.isNotEmpty() && editText2.text.isNotEmpty() -> {
                ...
                if (a < 0 || a == 0 && b < 0 || b == 0){
                    ...
                    val sa = (a+b)/2.toDouble()
                    Toast.makeText(requireContext(), "Их среднее арифметическое: $sa", Toast.LENGTH_LONG).show()
                }else {
